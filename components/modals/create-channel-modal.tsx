              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input disabled={isLoading} className="bg-zinc-300/50 border-0 focus-visible:ring-0 focus-visible:ring-offset-0 text-black"
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <Select disabled={isLoading} onValueChange={field.onChange} defaultValue={field.value}>
                      ...
                      focus:ring-0 text-black ring-offset-0 focus:ring-offset-0 capitalize
                      outline-none
                      ">
